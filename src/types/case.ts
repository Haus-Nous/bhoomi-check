...
export type CaseDetail = { case: LandCase; family: { members: FamilyMember[]; relationships: FamilyRelationship[] }; landParcels: LandParcel[]; documents: DocumentItem[]; surveyRecord?: SurveyRecord; verification: VerificationItem[]; guidance?: GuidanceItem[]; reviewPackets?: ReviewPacket[]; nextAction?: NextAction; timeline: TimelineEvent[] };
